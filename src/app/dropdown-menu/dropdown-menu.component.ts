...
@Component({
  selector: 'evt-dropdown-menu',
  templateUrl: './dropdown-menu.component.html',
  styleUrls: ['./dropdown-menu.component.scss'],
})
export class DropdownMenuComponent {
  @Output() itemClicked = new EventEmitter<string>();
  public dynamicItems: DropdownMenuItem[] = this.getDynamicItems();
  ...
  private getDynamicItems(): DropdownMenuItem[] {
  ...
  trackMenuItem(_index: number, item: DropdownMenuItem) {
    return item.id;
  }
